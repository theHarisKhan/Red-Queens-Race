...
function App() {
  ...
  useEffect(() => {
    ...
    setInterval(()=> {
      ...
      if(redQueen_alice_animation.playbackRate > 0.4){
      ...
      <div className="wrapper">
        ...
        <div className="earth">
          ...
          <div id="red-queen_and_alice">
            <img src="" srcSet={`${sprite_running} 2x`} alt="Alice and Queen Running" id="red-queen_and_alice_sprite" ref={redQueen_alice.ref}/>
          </div>
        </div>

        <div className="scenery" id="foreground1" ref={foreground1Movement.ref}>
          <img src={palm3_small} srcSet={`${palm3} 2x`} alt="palm3" id="palm3"/>
        </div>

        <div className="scenery" id="foreground2" ref={foreground2Movement.ref}>
          <img src={bush_small} srcSet={`${bush} 2x`} alt="bush" id="bush"/>
          <img src={w_rook_upright_small} srcSet={`${w_rook_upright} 2x`} alt="w_rook_ipright" id="w_rook_upright"/>
        </div>

        <div className="scenery" id="background1" ref={background1Movement.ref}>
          <img src={r_pawn_upright_small} srcSet={`${r_pawn_upright} 2x`} alt="r_pawn_upright" id="r_pawn_upright"/>
          <img src={w_rook_small} srcSet={`${w_rook} 2x`} alt="w_rook" id="w_rook"/>
          <img src={palm1_small} srcSet={`${palm1} 2x`} alt="palm1" id="palm1"/>
        </div>

        <div className="scenery" id="background2" ref={background2Movement.ref}>
          <img src={r_pawn_small} srcSet={`${r_pawn} 2x`} alt="r_pawn" id="r_pawn"/>
          <img src={r_knight_small} srcSet={`${r_knight} 2x`} alt="r_knight" id="r_knight"/>
          <img src={palm2_small} srcSet={`${palm2} 2x`} alt="palm2" id="palm2"/>
        </div>
